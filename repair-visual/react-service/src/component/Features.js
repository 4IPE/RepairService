...
const features = [
    ...
    },
    {
        ...
        description: "Средний опыт мастера 7 лет и 465 успешных ремонтов стиральных машин. Сертификаты и лицензии всегда на руках!",
        icon: "⭐"
    },
    {
        title: "Скорость",
    ...
    {
        title: "Гарантировано",
        description: "Вы защищены тремя гарантиями!",
        icon: "📝"
    },
    {
