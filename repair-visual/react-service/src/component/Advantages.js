...
const Advantages = () => {
    const advantages = [
        ...
        { number: 4, title: "Лучшие запчасти", description: "Закупаю качественные детали напрямую у проверенных поставщиков. Вы платите только их реальную стоимость" },
        { number: 2, title: "Срочный выезд", description: "Выезжаю за 20-30 минут, чтобы произвести ремонт бытовой техники как можно быстрее. Большинство поломок я устраняю на дому в течение часа" },
        { number: 5, title: "Любая сложность", description: "Выполняю ремонт любой сложности максимально быстро. Я всегда соблюдаю технологию и регламенты ремонта, что обеспечивает высокое качество" },
        { number: 3, title: "Диагностика 0 руб", description: "Начинаю ремонт только после точной инструментальной диагностики. Если цена Вас не устроит - платить не нужно" },
